...
export function FileExplorerPanel() {
  ...
  return (
    <aside className="workspace-tool-panel flex w-80 min-w-[260px] shrink-0 flex-col border-l bg-card max-md:fixed max-md:inset-0 max-md:z-40 max-md:w-full max-md:min-w-0">
